            ...
            <div class="grow xl:pt-[74px] pt-5 dark:bg-[#292929] xl:overflow-auto sidebar-scrollbar h-screen xl:w-1/2">
                <div class="flex justify-between items-center lg:mx-6 mb-4 xl:px-0 px-5 gap-5">
                    ...
                    <div class="flex justify-end 2xl:gap-10 gap-3">
                        <p
                            class="text-center word-counter text-color-2c dark:text-white whitespace-nowrap text-[15px] leading-[22px] font-medium">
                        </p>
                        <div class="flex justify-end gap-10 items-center">
                            <div class="relative">
                                ...
                                <div
                                    class="hidden dropdown-rtl origin-top-right absolute right-1 mt-2 w-[201px] border border-color-89 dark:border-color-47 rounded-lg bg-white dark:bg-[#333332] z-[9999] drop-down dropdown-shadow">
                                    <div>
                                        <a href="#"
                                        ...
                                        <a href="#"
                                            class="flex justify-start items-center gap-1.5 text-14 font-normal text-color-14 dark:text-white font-Figtree px-4 py-2 hover:bg-color-F6 hover:dark:bg-[#3A3A39] copy-text">
                                            <span class="w-4 h-4">
                                                <svg class="w-4 h-4 neg-transition-scale" xmlns="http://www.w3.org/2000/svg"
                                                    width="16" height="16" viewBox="0 0 16 16" fill="none">
    ...
    <div
        ...
        <div
            ...
            <div class="grow xl:pt-[74px] pt-5 dark:bg-[#292929] xl:overflow-auto sidebar-scrollbar h-screen xl:w-1/2">
                ...
                <!-- The text area and script to make words bold -->
