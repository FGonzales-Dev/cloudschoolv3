...
@section('content')
    ...
    @endphp
    <div
        class="w-[68.9%] 5xl:w-[85.9%] bg-[#F6F3F2] dark:bg-[#292929] flex flex-col flex-1 border-l dark:border-[#474746] border-color-DF h-screen">
        <div class="md:overflow-auto sidebar-scrollbar md:h-screen overflow-x-hidden xl:pb-6 article-scroll">
            ...
            <div class="px-5 6xl:px-[100px] 7xl:px-[140px] 8xl:px-[200px] 9xl:px-[261px] pt-[76px] lg:pt-[80px] pb-5">
                <div class="flex justify-between items-center">
                    <p class="text-color-14 text-24 font-semibold font-RedHat dark:text-white wrap-anywhere">
                        {{ __('Long Article') }}</p>
            ...
            <div
                class="subscription-main px-5 6xl:px-[100px] 7xl:px-[140px] 8xl:px-[200px] 9xl:px-[261px] flex gap-6 xl:flex-row flex-col">
                    ...
                    <div class="sticky top-[10%]">
                        <div class="bg-white dark:bg-[#3A3A39] px-6 pb-6 rounded-xl StepperFormWrapper">
                                        ...
                                        <div class="flex items-center StepperParent">
                                            <div class="Stepper">
                                                <div class="flex items-center text-gray-500 relative empty-circle">
                                                    <div style="background: #32B9C5"
                                                        class="flex items-center justify-center rounded-full h-6 w-6 ">
                                                        <p
                                                            class="flex items-center justify-center text-11 text-[#474746] bg-white dark:bg-[#3A3A39] dark:text-white font-medium font-Figtree h-[22px] w-[22px] py-1 rounded-full">
                                                            {{ __('1 ') }}</p>
                                                    </div>
                                                    <div
                                                        class="absolute top-0 -ml-[52px] text-center mt-8 w-32 text-xs font-medium font-Figtree text-[#474746] dark:text-[#DFDFDF]">
                                                        {{ __('Titles & Keywords') }}</div>
                                                </div>
                                                <div class="flex items-center relative full-circle hidden">
                                                    <div style="background: #32B9C5"
                                                        class="flex items-center justify-center rounded-full h-6 w-6 py-1">
                                                        <svg width="24" height="24" viewBox="0 0 24 24"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <circle cx="12" cy="12" r="12"
                                                                fill="url(#paint0_linear_10431_5608)" />
                                                            <path
                                                                d="M17.9398 7.91788C14.8844 10.7218 12.508 14.5819 11.7788 16.4428C11.7662 16.4931 11.7033 16.5434 11.6404 16.5434C11.6279 16.556 11.6279 16.556 11.6153 16.556C11.565 16.556 11.5147 16.5434 11.4896 16.5057L7.00077 11.9414C6.96305 11.9037 8.321 10.6967 8.38387 10.7469L10.8483 12.6833C11.8039 11.5517 14.1677 8.99921 17.4495 7C17.5123 7 17.9901 7.7167 17.9901 7.7167C18.0153 7.77957 17.9901 7.86758 17.9398 7.91788Z"
                                                                fill="white" />
                                                            <defs>
                                                                <linearGradient id="paint0_linear_10431_5608" x1="4.15256"
                                                                    y1="2.35886" x2="23.0334" y2="17.727"
                                                    ...
                                                    <div
                                                        class="absolute top-0 -ml-[52px] text-center mt-8 w-32 text-12 font-medium font-Figtree text-color-14 dark:text-white">
                                                        {{ __('Titles & Keywords') }}</div>
                                                </div>
                                            </div>
                                            <div style="background:#E6E6E6; height:1px; "class="flex-auto  ">
                                            </div>
                                            ...
                                            <div class="Stepper">
                                                <div class="flex items-center text-gray-500 relative empty-circle">
                                                    ...
                                                    <div
                                                        class="absolute top-0 -ml-[52px] text-center mt-8 w-32 text-12 font-medium font-Figtree text-[#474746] dark:text-[#DFDFDF]">
                                                        {{ __('Outlines') }}</div>
                                                </div>
                                                <div class="flex items-center relative full-circle hidden">
                                                    ...
                                                    <div
                                                        ...
                                                        <svg width="24" height="24" viewBox="0 0 24 24"
                                                            ...
                                                            <path
                                                                ...
                                                                fill="white" />
                                                            <defs>
                                                                <linearGradient id="paint0_linear_10431_5608"
                                                                    x1="4.15256" y1="2.35886" x2="23.0334"
                                                                    y2="17.727" gradientUnits="userSpaceOnUse">
                                                                    <stop stop-color="#FFF1BF" />
                                                                    <stop offset="0.2947" stop-color="#EC458D" />
                                                                    <stop offset="0.393" stop-color="#E14591" />
                                                                    <stop offset="0.561" stop-color="#C6469D" />
                            ...
                            <div class="ContinueButtonDiv hidden mt-3">
                                <button
                                    class="magic-bg w-full rounded-xl text-16 text-white font-semibold py-3 flex justify-center items-center gap-3 ContinueButton">
                                        ...
                                        <span>
                                            <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                                ...
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M4.87958 11.4712C5.16434 11.7316 5.62602 11.7316 5.91078 11.4712L10.2858 7.47124C10.5705 7.21089 10.5705 6.78878 10.2858 6.52843L5.91078 2.52843C5.62602 2.26808 5.16434 2.26808 4.87958 2.52843C4.59483 2.78878 4.59483 3.21089 4.87958 3.47124L8.73899 6.99984L4.87958 10.5284C4.59483 10.7888 4.59483 11.2109 4.87958 11.4712Z"
                                                    fill="white" />
                                            </svg>
                                        </span>
                                    </span>
                                    <svg class="loader animate-spin h-5 w-5 hidden" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <path
                                            ...
                                            mask="url(#path-1-inside-1_1032_3036)"></path>
                                        <defs>
                        ...
                        <p class="text-color-14 text-14 font-normal font-Figtree dark:text-white wrap-anywhere mt-4">
                            {{ __('Need extra credits?') }} <a class="underline font-medium"
                                href="{{ route('user.subscription.smallPlan') }}">{{ __('Buy credit packages.') }}</a>
                        </p>
                    </div>
                </div>
                <!-- Left Side -->
                ...
                <!-- Right Side -->
                <div
                    class="grow xl:px-0 9xl:pb-[46px] dark:bg-[#292929] xl:overflow-initial sidebar-scrollbar xl:w-1/2 FormDataWrapper">


                    <div class="pb-5">

                        <div
                            class="bg-white dark:bg-[#3A3A39] px-5 8xl:px-[140px] py-[37px] rounded-xl mb-5 TitleSuggestionText">
                            <p
                                class="text-color-89 text-[13px] text-center leading-5 font-normal font-Figtree wrap-anywhere">
                        ...
                        <div class="FormData Active">
                            <div class="TitleData">
                                @include('openai::blades.long_article.step_data.title', [
                                    'titles' => [],
                                ])
                            </div>
                        </div>
                        ...
                        <div
                            class="bg-white dark:bg-[#3A3A39] px-5 8xl:px-[140px] py-[37px] rounded-xl mb-5 OutlineSuggestionText">
                            <p
                                class="text-color-89 text-[13px] text-center leading-5 font-normal font-Figtree wrap-anywhere">
                        ...
                        <div class="FormData">
                            <div class="OutlineData">
                                @include('openai::blades.long_article.step_data.outline', [
                                    'outlinesData' => [],
                                ])
                            </div>
                        </div>
                        ...
                        <div class="FormData">
                            <div
                                class="bg-white dark:bg-[#3A3A39] px-5 8xl:px-[140px] py-[37px] h-[292px] rounded-xl mb-5 relative flex justify-center ArticleSuggestion hidden">
                                <p
                                    class="text-color-89 text-[13px] text-center leading-5 font-normal font-Figtree wrap-anywhere">
                                    {{ __('Please fill in the inputs and select your preferences. Your generated titles will appear here.') }}
                                </p>
                                <img class="w-[177px] h-[251px] object-cover absolute mt-[77px] avatar-img"
                                    src="{{ asset('Modules/OpenAI/Resources/assets/image/img-robo-3.png') }}"
                                    alt="{{ __('Image') }}">
                            </div>
                            <div
                                class="bg-white dark:bg-[#3A3A39] px-5 py-[37px] h- [292px] rounded-xl mb-5 relative ArticleSection">

                                <div class="ArticleData dark:text-white">

                                    @include('openai::blades.long_article.step_data.article', [
                                        'articleData' => null,
                                    ])
                                </div>
                                ...
                                <div class="mt-3">
                                    <a href="#"
                                        class="BlogEditButton hidden magic-bg rounded-lg text-[14px] text-white justify-center items-center font-medium py-[9px] flex text-center cursor-pointer font-Figtree w-max px-6 whitespace-nowrap gap-2">
