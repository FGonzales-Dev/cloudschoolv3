...
@section('content')
    {{-- main-content --}}
    <div
        class="w-[68.9%] 5xl:w-[85.9%] dark:bg-[#292929] flex flex-col flex-1 border-l dark:border-[#474746] border-color-DF h-screen border-right blog-parent">
        <div
                    ...
                    <div>
                        <div
                            ...
                            <a href="{{ route('user.documents') }}">
                                <svg class="neg-transition-scale" xmlns="http://www.w3.org/2000/svg" width="16"
                            ...
                            <p class="content-name px-3 line-clamp-single break-all">
                                {{ __('Content of a :x', ['x' => trimWords($useCase->template_title, 120) ?? '']) }}</p>
                        </div>
                    </div>
                    <div class="flex justify-end 2xl:gap-10 gap-3 items-center">
                        <p
                            class="hidden xl:block text-center word-counter text-sm font-medium text-color-14 dark:text-white font-Figtree whitespace-nowrap">
                        </p>
                        <p
                            class="magic-bg text-center content-update flex justify-center items-center gap-2 text-white font-Figtree xl:text-sm text-xs border border-color-DF py-1 xl:px-6 px-4 rounded-lg cursor-pointer font-medium">
                            {{ __('Update') }}
                            <svg class="animate-spin h-5 w-5 m-auto loader-update hidden" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="relative">
                            ...
                            <div
                                class="hidden origin-top-right absolute ltr:right-1 rtl:left-1 mt-2 w-[201px] border border-color-89 dark:border-color-47 rounded-lg bg-white dark:bg-[#333332] z-[9999] drop-down dropdown-shadow">
                                <div>
                                    <a href="javascript:void(0)"
                                        class="flex justify-start items-center gap-1.5 text-14 font-normal text-color-14 dark:text-white font-Figtree px-4 py-2 hover:bg-color-F6 dark:hover:bg-[#3A3A39] rounded-t-lg generate-pdf">
                                        <span class="w-4 h-4">
                                            <svg class="w-4 h-4 neg-transition-scale" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <a href="javascript:void(0)"
                                        class="flex justify-start items-center gap-1.5 text-14 font-normal text-color-14 dark:text-white font-Figtree px-4 py-2 hover:bg-color-F6 dark:hover:bg-[#3A3A39] generate-word">
                                        <span class="w-4 h-4">
                                            <svg class="w-4 h-4 neg-transition-scale" xmlns="http://www.w3.org/2000/svg"
                                                width="16" height="16" viewBox="0 0 16 16" fill="none">
                                                <g clip-path="url(#clip0_1227_1376)">
                                    ...
                                    <a href="javascript:void(0)"
                                        class="flex justify-start items-center gap-1.5 text-14 font-normal text-color-14 dark:text-white font-Figtree px-4 py-2 hover:bg-color-F6 dark:hover:bg-[#3A3A39] copy-text hover:rounded-b-lg">
                                        <span class="w-4 h-4">
                                            <svg class="w-4 h-4 neg-transition-scale" xmlns="http://www.w3.org/2000/svg"
                                                width="16" height="16" viewBox="0 0 16 16" fill="none">
                                                <g clip-path="url(#clip0_1227_1386)">
                                                    <path
                                                        d="M11.1053 2H4.15789C3.52105 2 3 2.49091 3 3.09091V10.7273H4.15789V3.09091H11.1053V2ZM10.5263 4.18182L14 7.45455V12.9091C14 13.5091 13.4789 14 12.8421 14H6.46789C5.83105 14 5.31579 13.5091 5.31579 12.9091L5.32158 5.27273C5.32158 4.67273 5.83684 4.18182 6.47368 4.18182H10.5263ZM9.94737 8H13.1316L9.94737 5V8Z"
                                                        fill="currentColor" />
                                                </g>
                                                <defs>
