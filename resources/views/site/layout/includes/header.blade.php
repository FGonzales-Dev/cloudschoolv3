                        ...
                        <div class="relative">
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <div class="pt-4 pb-2">
                                        <a href="{{ Auth::user()->role()->type == 'admin' ? route('dashboard') : route('openai') }}" class="flex justify-start items-center gap-1.5 text-14 font-normal text-color-14 dark:text-white font-Figtree px-[18px]">
