        ...
        {{-- <nav
            ...
            <div class="w-full h-[56px] flex items-center justify-between md:mx-5 gap-3">
                ...
                <div class="flex items-center justify-center">
                    <div class="w-[66px] h-[56px] mr-4 bg-[#464888] flex items-center justify-center md:hidden">
                        <svg class="collapse-icon pointer" width="26" height="26" viewBox="0 0 26 26" fill="none"
                            ...
                            <path d="M4 13H22M4 7H22M4 19H16" stroke="black" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"></path>
                        </svg>
                    </div>
                    ...
                    <div id="dropdowns-header" class="md:relative absolute top-1 md:top-0 right-[67px] md:right-1 flex justify-end items-center lg:gap-5 gap-3">
                        <div>
                            ...
                            <div class="cursor-pointer mt-3 md:mt-0 relative">
                                <a class=" text-16 cursor-pointer font-normal language-dropdown-click font-Figtree flex text-center gap-2 items-center justify-center">
                    ...
                    <div>
                        <div class="relative">
                            <a class="user-header-dropdown-click flex justify-center items-center gap-2 cursor-pointer">
                                ...
                                <div class="text-16 cursor-pointer font-normal font-Figtree flex text-center items-center justify-center rounded-full h-10 w-10 md:h-11 md:w-11 sign-in-button sign-in mr-2.5">
                                ...
                                <p class="text-16 font-semibold font-Figtree line-clamp-single hidden md:block">
                                    @php
