...
@php
    ...
    $subscription = Modules\Subscription\Entities\PackageSubscription::with(['package'])
        ->where('user_id', Auth::user()->id)
        ->first();
    $chatAddon = Modules\Addons\Entities\Addon::find('Chat')->isEnabled();

    if ($subscription != null) {
        $subscriptionMeta = Modules\Subscription\Entities\PackageSubscriptionMeta::where(
            'package_subscription_id',
            $subscription->id,
        )
            ->where('type', 'feature_word')
            ->get();
...
<nav id="sidenav"
    ...
    <div class="sidebar-bg-white h-full py-3.5 flex flex-col">
        <div
            class="sidebar-top relative flex items-center pl-5 dark:border-[#474746] top-option py-3.5 {{ $menu['class'] }} main-menu menus-height">
            <a href="{{ route('openai') }}" class="flex w-full gap-3 items-center">
                <span class="h-5 w-5 category-svg">
                    <svg class="category-svg" width="16" height="16" viewBox="0 0 16 16" fill="none"
                        ...
                        <defs>
                            <linearGradient id="paint0_linear_3040_2060" x1="10.2526" y1="13.6538" x2="5.04573"
                                y2="1.90371" gradientUnits="userSpaceOnUse">
            ...
            <span class="shrink-btn absolute top-[50%] opacity-1 right-3.5 cursor-pointer hidden md:block">
                ...
                <svg class="hidden dark:block neg-transition-scale" xmlns="http://www.w3.org/2000/svg" width="24"
        ...
        <div class="sidebar-links sidebar-accordion middle-sidebar-scroll overflow-y-scroll">
                        ...
                        @if (customerPanelAccess('long_article'))
                            <a href="{{ route('user.long_article.create') }}">
                                <div
                                    ...
                                    <p class="transion-hide accordion-menus"><span
                                            class="dark:text-white">{{ __('Long Article') }}</span></p>
                                </div>
                            </a>
                        @endif
                    </li>
                        ...
                        @if (customerPanelAccess('image'))
                            <a href="{{ route('user.imageTemplate') }}">
                                <div
                                    class="{{ $menu['class'] }} main-menu flex items-center gap-3 w-full py-3 pl-5 pr-[15px] text-left text-color-14 text-base leading-6 font-normal menus-height">
                                    <span class="w-5 h-5">
                                        <svg class="category-svg" width="20" height="20" viewBox="0 0 20 20"
                                            ...
                                            <defs>
                                                <linearGradient id="paint0_linear_1997_1547" x1="12.2526"
                                                    y1="15.6538" x2="7.04573" y2="3.90371"
                                                    gradientUnits="userSpaceOnUse">
                                                    <stop stop-color="{{ $menu['color1'] }}" />
                                                    <stop offset="1" stop-color="{{ $menu['color2'] }}" />
                                                </linearGradient>
                        ...
                        @if (customerPanelAccess('code'))
                            <a href="{{ route('user.codeTemplate') }}">
                                <div
                                    class="{{ $menu['class'] }} main-menu flex items-center gap-3 w-full py-3 pl-5 pr-[15px] text-left text-color-14 text-base leading-6 font-normal menus-height">
                                    <span class="w-5 h-5">
                                        <svg class="category-svg" width="20" height="16" viewBox="0 0 20 16"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                            ...
                                            <defs>
                                                <linearGradient id="paint0_linear_2838_1839" x1="17.5312"
                                                    y1="12.1666" x2="12.6806" y2="5.17616"
                                                    gradientUnits="userSpaceOnUse">
                                                    <stop stop-color="{{ $menu['color1'] }}" />
                                                    <stop offset="1" stop-color="{{ $menu['color2'] }}" />
                                                </linearGradient>
                                                <linearGradient id="paint1_linear_2838_1839" x1="4.58867"
                                                    y1="12.166" x2="-0.264378" y2="5.1743"
                                                    gradientUnits="userSpaceOnUse">
                                                    <stop stop-color="{{ $menu['color1'] }}" />
                                                    <stop offset="1" stop-color="{{ $menu['color2'] }}" />
                                                </linearGradient>
                                                <linearGradient id="paint2_linear_2838_1839" x1="10.8871"
                                                    y1="13.7348" x2="3.81928" y2="7.54154"
                                                    gradientUnits="userSpaceOnUse">
                                                    <stop stop-color="{{ $menu['color1'] }}" />
                                                    <stop offset="1" stop-color="{{ $menu['color2'] }}" />
                                                </linearGradient>
                        ...
                        @if (customerPanelAccess('speech_to_text'))
                            <a href="{{ route('user.speechTemplate') }}">
                                <div
                                    ...
                                    <p class="transion-hide accordion-menus"><span
                                            class="dark:text-white">{{ __('Speech to Text') }}</span></p>
                                </div>
                            </a>
                        @endif
                    </li>
                                ...
                                <div
                                    ...
                                    <span class="w-5 h-5">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="18"
                                            ...
                                            <path
                                                d="M7 11.1875C8.83398 11.1875 10.3203 9.71875 10.3203 7.90625V3.53125C10.3203 1.71875 8.83398 0.25 7 0.25C5.16602 0.25 3.67969 1.71875 3.67969 3.53125V7.90625C3.67969 9.71875 5.16602 11.1875 7 11.1875ZM13.4453 7.86719C13.4453 7.78125 13.375 7.71094 13.2891 7.71094H12.1172C12.0312 7.71094 11.9609 7.78125 11.9609 7.86719C11.9609 10.6074 9.74023 12.8281 7 12.8281C4.25977 12.8281 2.03906 10.6074 2.03906 7.86719C2.03906 7.78125 1.96875 7.71094 1.88281 7.71094H0.710938C0.625 7.71094 0.554688 7.78125 0.554688 7.86719C0.554688 11.1621 3.02734 13.8809 6.21875 14.2656V16.2656H3.38086C3.11328 16.2656 2.89844 16.5449 2.89844 16.8906V17.5938C2.89844 17.6797 2.95313 17.75 3.01953 17.75H10.9805C11.0469 17.75 11.1016 17.6797 11.1016 17.5938V16.8906C11.1016 16.5449 10.8867 16.2656 10.6191 16.2656H7.70312V14.2754C10.9316 13.9238 13.4453 11.1895 13.4453 7.86719Z"
                                                fill="url(#paint0_linear_9790_5737)" />
                                            <defs>
                                                <linearGradient id="paint0_linear_9790_5737" x1="8.9358"
                                                    y1="15.5961" x2="1.69141" y2="3.55391"
                                                    gradientUnits="userSpaceOnUse">
                                                    <stop stop-color="{{ $menu['color1'] }}" />
                                                    <stop offset="1" stop-color="{{ $menu['color2'] }}" />
                                                </linearGradient>
                        ...
                        <a href="{{ route('chat.index') }}">
                            <div
                                ...
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M1.66797 18.3332V3.33317C1.66797 2.87484 1.8313 2.48262 2.15797 2.1565C2.48464 1.83039 2.87686 1.66706 3.33464 1.6665H16.668C17.1263 1.6665 17.5188 1.82984 17.8455 2.1565C18.1721 2.48317 18.3352 2.87539 18.3346 3.33317V13.3332C18.3346 13.7915 18.1716 14.184 17.8455 14.5107C17.5194 14.8373 17.1269 15.0004 16.668 14.9998H5.0013L1.66797 18.3332ZM5.0013 11.6665H11.668V9.99984H5.0013V11.6665ZM5.0013 9.1665H15.0013V7.49984H5.0013V9.1665ZM5.0013 6.6665H15.0013V4.99984H5.0013V6.6665Z"
                                        fill="url(#paint0_linear_14102_7464)" />
                                    <defs>
                                        <linearGradient id="paint0_linear_14102_7464" x1="12.5042" y1="16.2818"
                                            x2="6.71879" y2="3.22618" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="{{ $menu['color1'] }}" />
                                            <stop offset="1" stop-color="{{ $menu['color2'] }}" />
                                        </linearGradient>
                                    </defs>
                    ...
                    <li>
                        @php
                            $menu = activeMenu(
                                ...
                                route('user.favouriteDocuments'),
                                route('user.editContent', ['slug' => $slug]),
                                route('user.codeList'),
                                route('user.codeView', ['slug' => $slug]),
                                route('user.textToSpeechList'),
                                route('user.textToSpeechView', ['id' => $id]),
                                route('user.speechLists'),
                                route('user.editSpeech', ['id' => $id]),
                                route('user.long_article.index'),
                                route('user.long_article.edit', $id),
                            );
                        ...
                        @endphp
                        @if (customerPanelAccess('template') ||
                                customerPanelAccess('voiceover') ||
                                customerPanelAccess('code') ||
                                customerPanelAccess('speech_to_text') ||
                                customerPanelAccess('long_article'))
                            <a href="{{ $view }}">
                                <div
                                    class="{{ $menu['class'] }} main-menu flex items-center gap-3 w-full py-3 pl-5 pr-[15px] text-left text-color-14 text-base leading-6 font-normal menus-height">
                                    <span class="w-5 h-5">
                                        <svg class="category-svg" width="18" height="18" viewBox="0 0 18 18"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                            ...
                                            <defs>
                                                <linearGradient id="paint0_linear_3321_1869" x1="11.628"
                                                    y1="15.5961" x2="5.55335" y2="1.88766"
                                                    gradientUnits="userSpaceOnUse">
                                                    <stop stop-color="{{ $menu['color1'] }}" />
                                                    <stop offset="1" stop-color="{{ $menu['color2'] }}" />
                                                </linearGradient>
                                    ...
                                    <span class="w-5 h-5">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                            ...
                                            <g clip-path="url(#clip0_12240_6893)">
                                                <path
                                                    d="M15.0703 1.5C15.0703 1.36739 15.0176 1.24021 14.9239 1.14645C14.8301 1.05268 14.7029 1 14.5703 1H3.57031C3.4377 1 3.31053 1.05268 3.21676 1.14645C3.12299 1.24021 3.07031 1.36739 3.07031 1.5V2H15.0703V1.5Z"
                                                    fill="url(#paint0_linear_12240_6893)" />
                                                <path
                                                    d="M16.0586 3.5C16.0586 3.36739 16.0059 3.24021 15.9121 3.14645C15.8184 3.05268 15.6912 3 15.5586 3H2.55859C2.42599 3 2.29881 3.05268 2.20504 3.14645C2.11127 3.24021 2.05859 3.36739 2.05859 3.5V4H16.0586V3.5Z"
                                                    fill="url(#paint1_linear_12240_6893)" />
                                                <path
                                                    d="M16.06 5H1.94C1.6907 5 1.4516 5.09904 1.27532 5.27532C1.09904 5.4516 1 5.6907 1 5.94V15.06C1 15.3093 1.09904 15.5484 1.27532 15.7247C1.4516 15.901 1.6907 16 1.94 16H16.06C16.3093 16 16.5484 15.901 16.7247 15.7247C16.901 15.5484 17 15.3093 17 15.06V5.94C17 5.6907 16.901 5.4516 16.7247 5.27532C16.5484 5.09904 16.3093 5 16.06 5ZM4.28 6.725C4.57667 6.725 4.86668 6.81297 5.11336 6.9778C5.36003 7.14262 5.55229 7.37689 5.66582 7.65098C5.77935 7.92506 5.80906 8.22666 5.75118 8.51764C5.6933 8.80861 5.55044 9.07588 5.34066 9.28566C5.13088 9.49544 4.86361 9.6383 4.57264 9.69618C4.28166 9.75406 3.98006 9.72435 3.70597 9.61082C3.43189 9.49729 3.19762 9.30503 3.0328 9.05836C2.86797 8.81168 2.78 8.52167 2.78 8.225C2.78 7.82718 2.93804 7.44564 3.21934 7.16434C3.50064 6.88304 3.88218 6.725 4.28 6.725ZM15 14H3L6.73 10.265C6.79649 10.199 6.88635 10.162 6.98 10.162C7.07365 10.162 7.16351 10.199 7.23 10.265L9.07 12.105L11.605 9.5C11.6715 9.43405 11.7613 9.39704 11.855 9.39704C11.9487 9.39704 12.0385 9.43405 12.105 9.5L15 12.395V14Z"
                                                    fill="url(#paint2_linear_12240_6893)" />
                                            </g>
                                            <defs>
                                                <linearGradient id="paint0_linear_12240_6893" x1="10.8724"
                                                    y1="1.87692" x2="10.8378" y2="0.941036"
                                                    gradientUnits="userSpaceOnUse">
                                                    <stop stop-color="{{ $menu['color1'] }}" />
                                                    <stop offset="1" stop-color="{{ $menu['color2'] }}" />
                                                </linearGradient>
                                                <linearGradient id="paint1_linear_12240_6893" x1="11.161"
                                                    y1="3.87692" x2="11.1314" y2="2.9407"
                                                    gradientUnits="userSpaceOnUse">
                                                    <stop stop-color="{{ $menu['color1'] }}" />
                                                    <stop offset="1" stop-color="{{ $menu['color2'] }}" />
                                                </linearGradient>
                                                <linearGradient id="paint2_linear_12240_6893" x1="11.4027"
                                                    y1="14.6461" x2="8.52888" y2="5.21289"
                                                    gradientUnits="userSpaceOnUse">
                                                    <stop stop-color="{{ $menu['color1'] }}" />
                                                    <stop offset="1" stop-color="{{ $menu['color2'] }}" />
                                                </linearGradient>
                ...
                <li>
                    ...
                    <a href="{{ route('user.folderView', ['slug' => 'drive-' . auth()->user()->id]) }}">
                        <div
                            ...
                            <p class="transion-hide accordion-menus"><span
                                    class="dark:text-white">{{ __('Drive') }}</span></p>
                        </div>
                    </a>
                </li>
                <li>
                    ...
                    <a href="{{ route('user.profile') }}">
                        <div
                            class="{{ $menu['class'] }} main-menu flex items-center gap-3 w-full py-3 pl-5 pr-[15px] text-left text-color-14 text-base leading-6 font-normal menus-height">
                            <span class="w-5 h-5">
                                <svg class="category-svg w-4 h-4" width="18" height="18" viewBox="0 0 18 18"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
            ...
            @if ($subscription != null && in_array($subscription->status, ['Active', 'Cancel']))
                ...
                @if (auth()->user()->id == $sessionUserId)
                    <div
                        class="bg-color-F6 dark:bg-[#434241] border border-color-DF dark:border-color-47 rounded-xl p-4 mx-5 mt-3 mb-7 plan-card">
                        <div class="flex justify-start items-cetner gap-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <defs>
                                    <linearGradient id="paint0_linear_5419_1957" x1="9.35152" y1="14.0307"
                                        x2="2.06253" y2="4.77849" gradientUnits="userSpaceOnUse">
                            ...
                            <p class="text-color-14 dark:text-white text-sm font-semibold font-Figtree">
                                {{ optional($subscription->package)->name }}</p>
                        </div>
                        <p class="text-color-14 dark:text-white font-Figtree font-normal text-sm mt-2.5">
                            {!! __('You have :x words left in your :y plan', [
                                'x' =>
                                    '<span class="total-word-used text-[#32B9C5] dark:text-[#32B9C5]">' .
                                    $creditUsed .
                                    '</span>' .
                                    '<span class="credit-limit text-[#32B9C5] dark:text-[#32B9C5]">/' .
                                    ($creditLimit == -1 ? __('Unlimited') : $creditLimit) .
                                    '</span>',
                                'y' => ($subscription->billing_cycle == 'days' ? $subscription->duration . ' ' : '') . $subscription->billing_cycle,
                            ]) !!}
                        </p>
                        <div
