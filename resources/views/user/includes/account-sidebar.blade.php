<div class="bg-[#F6F3F2] dark:bg-[#3A3A39] xl:!w-[401px] 5xl:!w-[474px] sidebar-scrollbar xl:overflow-auto xl:h-screen hidden md:block pt-14 h-screen md:h-max"
    id="account-sidebar">
            ...
            <div class="px-6 py-4 flex justify-between items-center">
                ...
                <div>
                    @if (url()->current() == route('user.profile'))
                        <svg class='block dark:hidden neg-transition-scale' xmlns="http://www.w3.org/2000/svg"
                        ...
                        <svg class='hidden dark:block neg-transition-scale' xmlns="http://www.w3.org/2000/svg"
                            width="18" height="18" viewBox="0 0 18 18" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M1.125 9C1.125 8.68934 1.37684 8.4375 1.6875 8.4375H14.9545L11.4148 4.89775C11.1951 4.67808 11.1951 4.32192 11.4148 4.10225C11.6344 3.88258 11.9906 3.88258 12.2102 4.10225L16.7102 8.60225C16.9299 8.82192 16.9299 9.17808 16.7102 9.39775L12.2102 13.8977C11.9906 14.1174 11.6344 14.1174 11.4148 13.8977C11.1951 13.6781 11.1951 13.3219 11.4148 13.1023L14.9545 9.5625H1.6875C1.37684 9.5625 1.125 9.31066 1.125 9Z"
                                fill="#ffffff"></path>
                    ...
                    @else
                        <svg class="neg-transition-scale" xmlns="http://www.w3.org/2000/svg" width="18"
            ...
            <div class="px-6 py-4 flex justify-between items-center">
                <div class="flex justify-center items-center gap-3">
                    <svg class="neg-transition-scale" width="18" height="18" viewBox="0 0 18 18" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M0 4.5C0 3.25736 1.00736 2.25 2.25 2.25H15.75C16.9926 2.25 18 3.25736 18 4.5V10.125H0V4.5ZM12.9375 5.625C12.6268 5.625 12.375 5.87684 12.375 6.1875V7.3125C12.375 7.62316 12.6268 7.875 12.9375 7.875H15.1875C15.4982 7.875 15.75 7.62316 15.75 7.3125V6.1875C15.75 5.87684 15.4982 5.625 15.1875 5.625H12.9375Z"
                            fill="url(#paint0_linear_2555_1960)" />
                        <path
                            d="M0 12.375V13.5C0 14.7426 1.00736 15.75 2.25 15.75H15.75C16.9926 15.75 18 14.7426 18 13.5V12.375H0Z"
                            fill="url(#paint1_linear_2555_1960)" />
                        <defs>
                            <linearGradient id="paint0_linear_2555_1960" x1="11.7031" y1="14.0884" x2="7.91656"
                                y2="2.6952" gradientUnits="userSpaceOnUse">
                                <stop stop-color="{{ $menu['color1'] }}" />
                                <stop offset="1" stop-color="{{ $menu['color2'] }}" />
                            </linearGradient>
                            <linearGradient id="paint1_linear_2555_1960" x1="11.7031" y1="14.0884" x2="7.91656"
                                y2="2.6952" gradientUnits="userSpaceOnUse">
                                <stop stop-color="{{ $menu['color1'] }}" />
                                <stop offset="1" stop-color="{{ $menu['color2'] }}" />
                            </linearGradient>
            ...
            <a class="bg-white dark:bg-[#474746] border border-color-DF dark:border-[#474746] border-design-3 cursor-pointer rounded-xl {{ $menu['class'] }}"
                ...
                <div class="px-6 py-4 flex justify-between items-center">
                    <div class="flex justify-center items-center gap-3">
                        ...
                        <svg class="neg-transition-scale" width="18" height="18" viewBox="0 0 18 18"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M0 4.5C0 3.25736 1.00736 2.25 2.25 2.25H15.75C16.9926 2.25 18 3.25736 18 4.5V13.5C18 14.7426 16.9926 15.75 15.75 15.75H2.25C1.00736 15.75 0 14.7426 0 13.5V4.5ZM10.125 6.1875C10.125 5.87684 10.3768 5.625 10.6875 5.625H15.1875C15.4982 5.625 15.75 5.87684 15.75 6.1875C15.75 6.49816 15.4982 6.75 15.1875 6.75H10.6875C10.3768 6.75 10.125 6.49816 10.125 6.1875ZM10.125 9C10.125 8.68934 10.3768 8.4375 10.6875 8.4375H15.1875C15.4982 8.4375 15.75 8.68934 15.75 9C15.75 9.31066 15.4982 9.5625 15.1875 9.5625H10.6875C10.3768 9.5625 10.125 9.31066 10.125 9ZM11.25 11.8125C11.25 11.5018 11.5018 11.25 11.8125 11.25H15.1875C15.4982 11.25 15.75 11.5018 15.75 11.8125C15.75 12.1232 15.4982 12.375 15.1875 12.375H11.8125C11.5018 12.375 11.25 12.1232 11.25 11.8125ZM10.125 14.0625C10.125 14.2535 10.1094 14.4413 10.0794 14.625H2.24998C1.69826 14.625 1.2393 14.2278 1.1434 13.7038C1.35047 11.6973 3.27788 10.125 5.62498 10.125C8.11026 10.125 10.125 11.8879 10.125 14.0625ZM7.87498 6.75C7.87498 7.99264 6.86762 9 5.62498 9C4.38234 9 3.37498 7.99264 3.37498 6.75C3.37498 5.50736 4.38234 4.5 5.62498 4.5C6.86762 4.5 7.87498 5.50736 7.87498 6.75Z"
                                fill="url(#paint0_linear_3352_1881)" />
                            <defs>
                                <linearGradient id="paint0_linear_3352_1881" x1="11.7031" y1="14.0884"
                                    x2="7.91656" y2="2.6952" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="{{ $menu['color1'] }}" />
                                    <stop offset="1" stop-color="{{ $menu['color2'] }}" />
                        </svg>
                        <p class="font-normal leading-[26px] text-lg text-color-14 dark:text-white">
                    ...
                    <div>
                        @if (url()->current() == route('user.subscription.teamList'))
                            <svg class='block dark:hidden' xmlns="http://www.w3.org/2000/svg" width="18"
                                height="18" viewBox="0 0 18 18" fill="none">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M1.125 9C1.125 8.68934 1.37684 8.4375 1.6875 8.4375H14.9545L11.4148 4.89775C11.1951 4.67808 11.1951 4.32192 11.4148 4.10225C11.6344 3.88258 11.9906 3.88258 12.2102 4.10225L16.7102 8.60225C16.9299 8.82192 16.9299 9.17808 16.7102 9.39775L12.2102 13.8977C11.9906 14.1174 11.6344 14.1174 11.4148 13.8977C11.1951 13.6781 11.1951 13.3219 11.4148 13.1023L14.9545 9.5625H1.6875C1.37684 9.5625 1.125 9.31066 1.125 9Z"
                                    fill="#000000"></path>
                            </svg>
                            <svg class='hidden dark:block' xmlns="http://www.w3.org/2000/svg" width="18"
                                height="18" viewBox="0 0 18 18" fill="none">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M1.125 9C1.125 8.68934 1.37684 8.4375 1.6875 8.4375H14.9545L11.4148 4.89775C11.1951 4.67808 11.1951 4.32192 11.4148 4.10225C11.6344 3.88258 11.9906 3.88258 12.2102 4.10225L16.7102 8.60225C16.9299 8.82192 16.9299 9.17808 16.7102 9.39775L12.2102 13.8977C11.9906 14.1174 11.6344 14.1174 11.4148 13.8977C11.1951 13.6781 11.1951 13.3219 11.4148 13.1023L14.9545 9.5625H1.6875C1.37684 9.5625 1.125 9.31066 1.125 9Z"
                                    fill="#ffffff"></path>
                ...
                <div class="flex justify-center items-center gap-3">
                    ...
                    <svg width="16" height="20" viewBox="0 0 16 20" fill="none"
                        ...
                        <path
                            ...
                            fill="url(#paint0_linear_3352_1882)" />
                        <defs>
                            <linearGradient id="paint0_linear_3352_1882" x1="10.2495" y1="17.5384"
                                x2="2.03526" y2="3.65527" gradientUnits="userSpaceOnUse">
                                <stop stop-color="{{ $menu['color1'] }}" />
                                <stop offset="1" stop-color="{{ $menu['color2'] }}" />
                            </linearGradient>
        ...
        <a class="bg-white dark:bg-[#474746] border border-color-DF dark:border-[#474746] border-design-3 cursor-pointer rounded-xl {{ $menu['class'] }}"
            ...
            <div class="px-6 py-4 flex justify-between items-center">
                <div class="flex justify-center items-center gap-3">
                    ...
                    <p class="font-normal leading-[26px] text-lg text-color-14 dark:text-white">{{ __('Logout') }}
                    </p>
                </div>
                <div>
                    <svg class="neg-transition-scale" xmlns="http://www.w3.org/2000/svg" width="18"
